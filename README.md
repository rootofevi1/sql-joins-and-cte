...
Учебный проект Александра из «Школы 21» (`SQLB3_Retrieving_data`): **11 SQL-файлов** на предметной области заказов и посещений пиццерий. Часть серии из девяти проектов [SQL-портфолио](https://github.com/rootofevi1#sql-и-postgresql).
